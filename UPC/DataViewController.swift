    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destinationVC = segue.destination as? SeparateInfoViewController {
            ...
            case 12:
                ...
                destinationVC.startValue = conditions[0] < 50 ? conditions[0] : 50
                ...
                destinationVC.advices = ["Adjust your air conditioning according to sensor's indicator",
                                         "You can also adjust your batteries' temperature",
                                         "", ""]
                destinationVC.titleText = "What you can do to improve conditions"
            case 13:
                destinationVC.ringType = "hum"
                destinationVC.startValue = conditions[1] < 100 ? conditions[1] : 100
            ...
            case 14:
                ...
                destinationVC.startValue = conditions[2] < 65 ? conditions[2] : 65
                destinationVC.nums = [11, 32, 53]
                destinationVC.name = "Noise"
                destinationVC.advices = ["It could be too noisy outside, you'd better close your windows",
                                         "Please, turn off your TV", "", ""]
                destinationVC.titleText = "What you can do to improve conditions"
            case 15:
                destinationVC.ringType = "light"
                destinationVC.startValue = conditions[3] < 15 ? conditions[3] : 15
